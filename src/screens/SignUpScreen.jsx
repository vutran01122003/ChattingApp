...
function SignUpScreen({navigation}) {
  ...
  useEffect(() => {
    if (isFocus) setIsModalVisible(false);
    setPhoneNumber('');
  }, [isFocus]);
      ...
      <View className="px-6 pt-4 flex-1">
        ...
        <View className="mb-3 flex-row items-center">
          ...
          <Text className="text-gray-800 ml-2">
            Tôi đồng ý với các{' '}
            <Text className="text-blue-500">điều khoản sử dụng Lochat</Text>
          </Text>
        </View>
        ...
        <View className="mb-6 flex-row items-center">
          ...
          <Text className="text-gray-800 ml-2">
            ...
            <Text className="text-blue-500">
              điều khoản Mạng xã hội của Lochat
            </Text>
          </Text>
        </View>
        ...
        <TouchableOpacity
          className={`rounded-2xl py-4 items-center ${
            termsChecked && socialTermsChecked && isPhoneValid
              ? 'bg-blue-500'
              : 'bg-gray-300'
          }`}
          ...
          <View className="flex-1 justify-center items-center bg-black/50">
            <View className="bg-white w-80 p-6 rounded-lg shadow-lg">
              ...
              <Text className="text-gray-600 text-sm mt-2">
                Lochat sẽ gửi mã xác thực cho bạn qua số điện thoại này
              </Text>
