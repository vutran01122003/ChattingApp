...
import {groupConversationsSelector, userSelector} from '../redux/selector';
...
export default function ContactScreen() {
  ...
  const groups = [...groupConversation].sort((a, b) => {
            ...
            friendList.map((friend, index) => {
              ...
              return (
                <View key={index}>
                  ...
                  <Account user={friend} authUser={user} />
                </View>
              );
            })
          ) : (
      ...
      <ScrollView className="flex-1">
        {groups.map((group, index) => (
          <TouchableOpacity
            ...
            onPress={() => {
              navigate('ChatMessage', {conversationId: group.conversation_id});
            }}>
      ...
      <View className="flex-row border-b border-gray-200">
        <TouchableOpacity
          className={`flex-1 py-3 items-center ${
            activeTab === 'Bạn bè' ? 'border-b-2 border-blue-500' : ''
          }`}
        ...
        <TouchableOpacity
          className={`flex-1 py-3 items-center ${
            activeTab === 'Nhóm' ? 'border-b-2 border-blue-500' : ''
          }`}
