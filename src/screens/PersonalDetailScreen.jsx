  ...
  return (
    <View className="flex-1 bg-gray-100 mt-8">
      ...
      <View className="bg-blue-500 p-4 flex-row items-center">
        ...
        <Text className="text-white text-lg font-medium ml-3">Thông tin cá nhân</Text>
      </View>
      ...
      <View className="mt-8 bg-white">
        ...
        <View className="flex-row items-center p-4 border-b border-gray-100">
          ...
          <View className="flex-1">
            <Text className="text-gray-500">Tên Zalo</Text>
          </View>
        ...
        <View className="flex-row items-center p-4 border-b border-gray-100">
          ...
          <Text className="font-medium">{formatDate(new Date(user?.date_of_birth))}</Text>
        </View>
        ...
        <View className="flex-row items-center p-4">
          ...
          <Text className="font-medium">{user?.gender==="male"?"Nam":"Nữ"}</Text>
        </View>
      </View>

      {/* Edit Button */}
      <View className="mt-4 mx-4">
        <TouchableOpacity className="bg-gray-200 p-3 rounded-md flex-row justify-center items-center"
